...
prioritize volume over parallelism. Unlike Slurm, which focuses on tightly coupled MPI
...
Inspired by OpenLava 2.2 and refined with algorithmic insights from Donald Knuth’s
...
We don’t try to be Slurm. We aim to beat it—on speed, on simplicity, and on the elegance of our scheduling log
...
Maintainer: lutram30@gmail.com
Project email (coming soon): livelite@contributors.org

## Library Build Options

LavaLite builds both static (`.a`) and shared (`.so`) libraries by default.
