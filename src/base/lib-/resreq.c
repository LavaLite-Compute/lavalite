/* $Id: resreq.c,v 1.3 2007/08/15 22:18:49 tmizan Exp $
...
static int parseSelect(char *, struct resVal *, struct lsInfo *, bool, int);
...
static int parseSelect(char *resReq, struct resVal *resVal,
                       struct lsInfo *lsInfo, bool parseXor, int options)
{
