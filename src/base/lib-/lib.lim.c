...
static int callLimTCP_(char *, char **, size_t, struct protocol_header *, int);
static int callLimUDP_(char *, char *, size_t, struct protocol_header *, char *,
                       int);

int32_t lsf_lim_version = -1;

int callLim_(enum limReqCode reqCode, void *dsend, bool (*xdr_sfunc)(),
             void *drecv, bool (*xdr_rfunc)(), char *host, int options,
...
static int callLimTCP_(char *reqbuf, char **rep_buf, size_t req_size,
                       struct protocol_header *reply_hdr, int options)
{
...
static int callLimUDP_(char *req_buf, char *rep_buf, size_t len,
                       struct protocol_header *reqHdr, char *host, int options)
{
