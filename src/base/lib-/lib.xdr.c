...
// Protocol function
static bool marshal_protocol_header(XDR *xdrs, struct protocol_header *header);
...
bool xdr_array_string(XDR *xdrs, char **str, int maxlen, int arraysize)
{
...
bool xdr_time_t(XDR *xdrs, time_t *t)
{
...
ssize_t writeEncodeHdr_(int s, struct protocol_header *hdr,
                        ssize_t (*writeFunc)())
{
    XDR xdrs;
    struct protocol_header buf;
...
bool xdr_stringLen(XDR *xdrs, struct stringLen *str,
                     struct protocol_header *Hdr)
{
    if (xdrs->x_op == XDR_DECODE)
        str->name[0] = '\0';
...
bool xdr_lsfLimit(XDR *xdrs, struct lsfLimit *limits,
                    struct protocol_header *hdr)
{
...
bool xdr_portno(XDR *xdrs, uint16_t *port)
{
    uint32_t n;
...
bool xdr_sockaddr_in(XDR *xdrs, struct sockaddr_in *addr)
{
    uint32_t fam;
    uint32_t port;
    uint32_t ip;
...
bool xdr_debugReq(XDR *xdrs, struct debugReq *debugReq,
                    struct protocol_header *hdr)
{
    static char *sp = NULL;
...
void xdr_free_payload(bool (*xdr_func)(), void *ptr, struct protocol_header *hdr)
{
    XDR xdrs;
...
bool xdr_array_element(XDR *xdrs,     // the stream
                         void *data,    // the struct on the wore
                         void *ctx,     // some extra if needed
                         bool (*f)()) // marshal function
{
    if (!f(xdrs, data, ctx))
        return false;
...
bool xdr_lsfRusage(XDR *xdrs, struct lsfRusage *lsfRu, void *)
{
...
bool xdr_var_string(XDR *xdrs, char **str)
{
    if (xdrs->x_op == XDR_ENCODE) {
...
bool xdr_lenData(XDR *xdrs, struct lenData *ld)
{
    char *sp;
...
bool xdr_lsfAuth(XDR *xdrs, struct lsfAuth *auth, struct protocol_header *hdr)
{
    char *sp;
...
static bool xdr_pidInfo(XDR *xdrs, struct pidInfo *pidInfo, void *ctx)
{
...
bool xdr_jRusage(XDR *xdrs, struct jRusage *runRusage, void *)
{
    int i;
...
bool xdr_wire_host_info(XDR *xdrs, struct wire_host *info,
                          struct protocol_header *hdr)
{
...
bool xdr_wire_host_reply(XDR *xdrs, struct wire_host_reply *reply,
                           struct protocol_header *hdr)
{
    int i;
...
bool xdr_wire_load(XDR *xdrs, struct wire_load *wp)
{
...
bool xdr_wire_load_reply(XDR *xdrs, struct wire_load_reply *rp)
{
    int i;
...
bool xdr_wire_res(XDR *xdrs, struct wire_res *wr)
{
...
bool xdr_wire_host_type(XDR *xdrs, struct wire_host_type *ht)
{
    return xdr_opaque(xdrs, ht->name, MAXLSFNAMELEN);
}

bool xdr_wire_host_model(XDR *xdrs, struct wire_host_model *hm)
{
...
bool xdr_wire_lsinfo(XDR *xdrs, struct wire_lsinfo *r)
{
    int i;
...
bool xdr_wire_cluster_info(XDR *xdrs, struct wire_cluster_info *ci)
{
