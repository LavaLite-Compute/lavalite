...
static bool_t xdr_placeInfo(XDR *xdrs, struct placeInfo *placeInfo, void *ctx)
{
    char *sp;
...
static bool_t xdr_hostLoad(XDR *xdrs, struct hostLoad *loadVec, void *ctx)
{
    char *sp;
    int i;
...
bool_t xdr_decisionReq(XDR *xdrs, struct decisionReq *decisionReqPtr,
...
bool_t xdr_placeReply(XDR *xdrs, struct placeReply *placeRepPtr,
                      struct packet_header *hdr)
{
    int i, status = false;
    static char *memp;
...
bool_t xdr_loadReply(XDR *xdrs, struct loadReply *loadReplyPtr,
                     struct packet_header *hdr)
{
    char *sp;
    int i, status = true;
...
bool_t xdr_jobXfer(XDR *xdrs, struct jobXfer *jobXferPtr,
                   struct packet_header *hdr)
{
    int i, status = false;
    char *sp;
...
bool_t xdr_hostInfoReply(XDR *xdrs, struct hostInfoReply *hostInfoReply,
                         struct packet_header *hdr)
{
    int i, status;
...
bool_t xdr_shortHInfo(XDR *xdrs, struct shortHInfo *shortHInfo, void *cntx)
{
...
static bool_t xdr_shortLsInfo(XDR *xdrs, struct shortLsInfo *shortLInfo,
                              void *ctx)
{
    int i;
...
bool_t xdr_limLock(XDR *xdrs, struct limLock *limLockPtr,
                   struct packet_header *hdr)
{
    char *sp;
...
static bool_t xdr_resItem(XDR *xdrs, struct resItem *resItem, void *ctx)
{
    char *sp;
    char *sp1;
...
bool_t xdr_lsInfo(XDR *xdrs, struct lsInfo *lsInfoPtr,
                  struct packet_header *hdr)
{
    int i;
    char *sp = (char *) 0;
...
bool_t xdr_masterInfo(XDR *xdrs, struct masterInfo *mInfoPtr,
                      struct packet_header *hdr)
{
    char *sp;
...
bool_t xdr_clusterInfoReq(XDR *xdrs, struct clusterInfoReq *clusterInfoReq,
                          struct packet_header *hdr)
{
...
bool_t xdr_clusterInfoReply(XDR *xdrs,
...
bool_t xdr_shortCInfo(XDR *xdrs, struct shortCInfo *clustInfoPtr, void *ctx)
{
    char *sp1;
    char *sp2;
    char *sp3;
...
bool_t xdr_cInfo(XDR *xdrs, struct cInfo *cInfo, struct packet_header *hdr)
{
    char *sp1, *sp2, *sp3;
    int i;
...
bool_t xdr_resourceInfoReq(XDR *xdrs, struct resourceInfoReq *resourceInfoReq,
                           struct packet_header *hdr)
{
    int i;
...
static bool_t xdr_lsResourceInfo(XDR *xdrs,
...
bool_t xdr_resourceInfoReply(XDR *xdrs,
...
static bool_t xdr_lsResourceInstance(XDR *xdrs,
