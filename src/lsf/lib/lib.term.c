/* $Id: lib.term.c,v 1.4 2007/08/15 22:18:51 tmizan Exp $
...
static tcflag_t out_table[OUT_TABLE_SIZE] = {
    OPOST, OLCUC, ONLCR, OCRNL, ONOCR, ONLRET, OFILL,  OFDEL, NLDLY, NL0,
    NL1,   CRDLY, CR0,   CR1,   CR2,   CR3,    TABDLY, TAB0,  TAB1,  TAB2,
    TAB3,  BSDLY, BS0,   BS1,   VTDLY, VT0,    VT1,    FFDLY, FF0,   FF1};

#define CTRL_TABLE_SIZE 12
static tcflag_t ctrl_table[CTRL_TABLE_SIZE] = {CLOCAL, CREAD,  CSIZE,  CS5,
                                               CS6,    CS7,    CS8,    CSTOPB,
                                               HUPCL,  PARENB, PARODD, LOBLK};

#define LOC_TABLE_SIZE 10
static tcflag_t loc_table[LOC_TABLE_SIZE] = {
