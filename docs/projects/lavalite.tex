...
to continue the legacy of OpenLava/LSF while evolving it into a modern,
...
\section{Rationale}
IBM's closure of OpenLava left a gap: Slurm dominates HPC,
Kubernetes dominates microservices, but there remains a need for
simple batch execution and analytics without container orchestration.
LavaLite fills that space.
