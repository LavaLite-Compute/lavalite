...
int mbd_sbd_register(XDR *, struct mbd_client_node *, struct protocol_header *);
...
int mbd_signal_running_job(struct jData *, struct signalReq *,
                           struct lsfAuth *);
int mbd_job_signal_reply(struct mbd_client_node *, XDR *, struct protocol_header *);
...
void mbd_handle_compact_done(XDR *, int, struct protocol_header *);
