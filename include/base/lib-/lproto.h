...
extern bool xdr_debugReq(XDR *xdrs, struct debugReq *debugReq,
...
extern int expectReturnCode_(int, int, struct protocol_header *);
extern int ackAsyncReturnCode_(int, struct protocol_header *);
...
extern void init_pack_hdr(struct protocol_header *);
...
extern bool isLSFAdmin_(const char *name);
