...
extern int listInsertEntryBefore(LIST_T *list, LIST_ENTRY_T *succ,
                                 LIST_ENTRY_T *entry);
extern int listInsertEntryAfter(LIST_T *list, LIST_ENTRY_T *pred,
                                LIST_ENTRY_T *entry);
...
extern LIST_ENTRY_T *listSearchEntry(LIST_T *list, void *subject,
                                     bool (*equal)(void *, void *, int),
                                     int hint);
...
extern void list2Vector(LIST_T *list, int direction, void *vector,
                        void (*putVecEnt)(void *vector, int index,
                                          LIST_ENTRY_T *entry));

extern void listDisplay(LIST_T *list, int direction,
                        void (*displayEntry)(LIST_ENTRY_T *, void *),
                        void *hint);

extern void listCat(LIST_T *list, int direction, char *buffer, int bufferSize,
...
typedef bool (*LIST_ENTRY_SELECT_OP_T)(void *extra, LIST_EVENT_T *);

typedef int (*LIST_EVENT_CALLBACK_FUNC_T)(LIST_T *list, void *extra,
                                          LIST_EVENT_T *event);
...
extern LIST_OBSERVER_T *listObserverCreate(char *name, void *extra,
                                           LIST_ENTRY_SELECT_OP_T select, ...);
...
extern int listIteratorSetCurEntry(LIST_ITERATOR_T *iter, LIST_ENTRY_T *ent,
                                   bool validateEnt);
...
extern bool listIteratorIsEndOfList(LIST_ITERATOR_T *iter);
