...
extern void reconfigReq(XDR *, struct sockaddr_in *, struct protocol_header *);
extern void shutdownReq(XDR *, struct sockaddr_in *, struct protocol_header *);
extern void limDebugReq(XDR *, struct sockaddr_in *, struct protocol_header *);
extern void lockReq(XDR *, struct sockaddr_in *, struct protocol_header *);
extern int limPortOk(const struct sockaddr_in *);
extern void servAvailReq(XDR *, struct hostNode *, struct sockaddr_in *,
                         struct protocol_header *);
extern void masterRegister(XDR *, struct sockaddr_in *, struct protocol_header *);
extern void rcvConfInfo(XDR *, struct sockaddr_in *, struct protocol_header *);
extern void tellMasterWho(XDR *, struct sockaddr_in *, struct protocol_header *);
...
extern void rcvLoad(XDR *, struct sockaddr_in *, struct protocol_header *);
...
extern void errorBack(struct sockaddr_in *, struct protocol_header *,
...
extern void chkResReq(XDR *, struct sockaddr_in *, struct protocol_header *);
...
extern int xdr_loadmatrix(XDR *, int, struct loadVectorStruct *,
                          struct protocol_header *);
extern int xdr_masterReg(XDR *, struct masterReg *, struct protocol_header *);
extern int xdr_statInfo(XDR *, struct statInfo *, struct protocol_header *);
extern struct liStruct *li;
extern int li_len;
...
void cluster_name_req(XDR *, struct sockaddr_in *, struct protocol_header *);
void master_info_req(XDR *, struct sockaddr_in *, struct protocol_header *);
// This does not do anything, remove it
void ping_req(XDR *, struct sockaddr_in *, struct protocol_header *);
// The rest of API processing is TCP
void clus_info_req(XDR *, struct client_node *, struct protocol_header *);
void load_req(XDR *, struct client_node *, struct protocol_header *);
void host_info_req(XDR *, struct client_node *, struct protocol_header *);
// Avoid the same function name as the data structure
void resource_info_req(XDR *, struct client_node *, struct protocol_header *);
void info_req(XDR *, struct client_node *, struct protocol_header *);
void shutdown_client(struct client_node *);
void wrong_master(struct client_node *);
void send_header(struct client_node *, struct protocol_header *,
                 enum limReplyCode);
...
void master_beacon_recv(XDR *, struct sockaddr_in *, struct protocol_header *);
bool xdr_master_beacon(XDR *, struct master_beacon *);
void read_load(void);
int send_load_update(void);
void rcv_load_update(XDR *, struct sockaddr_in *, struct protocol_header *);
bool xdr_wire_load_update(XDR *, struct wire_load_update *);
